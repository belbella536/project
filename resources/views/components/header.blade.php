        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/dashboard" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ asset('images/uin.png') }}" alt="" height="40">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ asset('images/light.png') }}" alt="" height="75">
                    </span>
                </a>
                ...
                <a href="/dashboard" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('images/dark.png') }}" alt="" height="75">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item bg-light-subtle border-start border-end"
                    ...
                    <!-- Gunakan avatar default jika tidak ada foto profil dinamis -->
                    <img class="rounded-circle header-profile-user" src="{{ asset('images/users/avatar-1.jpg') }}"
                        alt="Header Avatar">
                    <!-- Menampilkan Nama User dari session Auth Laravel -->
